...
var_template = {
    ...
    "nGoodElectron":{
      "title" : "number of good electrons",
      "nbins" : 5,
      "min" : -0.5,
      "max" : 4.5,
      "log" : True,
